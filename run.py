...
if __name__ == '__main__':
	...
	parser.add_argument('-causal_sparse',       dest='causal_sparse',       default=0.0001, type=float, help='Weight for sparsity loss')
	parser.add_argument('-causal_target',       dest='causal_target',       default=0.5,   type=float, help='Target sparsity rate (no penalty below this)')
	...
	parser.add_argument('-causal_warmup',       dest='causal_warmup',       default=30,    type=int,   help='Warmup epochs for sparsity loss')
